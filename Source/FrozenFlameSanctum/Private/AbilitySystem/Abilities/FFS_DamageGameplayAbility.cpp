...
void UFFS_DamageGameplayAbility::DealDamage(AActor* TargetActor)
{
...
float UFFS_DamageGameplayAbility::GetDamageByDamageType(float InLevel, const FGameplayTag& DamageType)
{
